...
{{< downloadthis data/r_course.zip dname="r_course" label="Download the R project for BIOL90042 workshops" icon="file-earmark-arrow-down" type="primary" class="data-button" id="rproj" >}}
